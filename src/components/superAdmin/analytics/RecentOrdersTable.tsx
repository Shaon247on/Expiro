          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-gray-100">
                {["Tracking no", "Name", "Price", "Total Order", "Total Amount"].map(
                  (h) => (
                    <TableHead
                      key={h}
                    ...
                    >
                      <span className="flex items-center gap-1">
                        {h}
                        {["Tracking no", "Name", "Price", "Total Order"].includes(h) && (
            ...
            <TableBody>
              {orders.map((order, i) => (
                ...
                >
                  ...
                  <TableCell className="py-4">
                    <span className="inline-flex items-center justify-center px-4 py-1.5 rounded-md bg-[#2d5a3d] text-white text-sm font-semibold min-w-[52px]">
                      {order.totalOrder}
                    </span>
                  </TableCell>
