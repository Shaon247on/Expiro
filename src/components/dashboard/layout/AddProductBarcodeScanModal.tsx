...
interface AddProductBarcodeScanModalProps {
  open: boolean;
...
export default function AddProductBarcodeScanModal({
  open,
  onDetected,
  onSkip,
  onClose,
}: AddProductBarcodeScanModalProps) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label="Add product barcode scanner"
    >
      <div className="flex items-center justify-between px-5 pt-5 pb-4 shrink-0">
        <div className="flex items-center gap-2.5">
          <div
            className="w-8 h-8 rounded-xl flex items-center justify-center"
            style={{ backgroundColor: "rgba(58,115,38,0.25)" }}
          >
          ...
          <div>
            ...
            >
              Scan first, then continue to add product
            </p>
          </div>
        </div>
      ...
      >
        ...
        {status === "starting" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
            <Loader2 size={32} className="animate-spin" style={{ color: "#86EFAC" }} />
      ...
      <div className="px-5 pt-5 pb-6 space-y-4 shrink-0">
        ...
        {!showManual ? (
          ...
          <div className="space-y-2">
            ...
            <button
              onClick={onSkip}
              className="w-full text-center text-[12px] font-medium py-2 rounded-xl transition-colors"
              style={{
