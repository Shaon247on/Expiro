...
import { deleteCategoryAction } from "@/actions/admin/category.action";
    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors disabled:opacity-50"
          ...
          <div className="p-6 pt-5">
            ...
            <AlertDialogHeader className="space-y-2 mb-5 text-center">
              ...
              <AlertDialogDescription className="text-[13px] leading-relaxed text-gray-500 text-center">
                ...
                <span className="font-semibold" style={{ color: "#1A3340" }}>
